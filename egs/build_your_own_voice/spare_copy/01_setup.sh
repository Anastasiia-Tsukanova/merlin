...
echo "QuestionFile=questions-gottingen_fr.hed" >> $global_config_file
...
echo "Train=115" >> $global_config_file 
echo "Valid=6" >> $global_config_file 
echo "Test=2" >> $global_config_file 
echo "" >> $global_config_file
...
echo "FESTDIR=${merlin_dir}/tools/festival/bin" >> $global_config_file
